...
namespace GLMS.Shared.Models.DTOs
{
        ...
        public class ClientDto { public int Id { get; set; } public string Name { get; set; } = ""; public string ContractDetails { get; set; } = ""; public string Region { get; set; } = ""; public DateTime CreatedOn { get; set; } public int ContractCount { get; set; } public List<ContractDto> Contracts { get; set; } = new();}
